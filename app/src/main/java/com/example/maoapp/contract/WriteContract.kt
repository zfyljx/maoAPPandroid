...
interface WriteContract {
    ...
    interface Presenter<in T> : BaseContract.BasePresenter<T> {
        ...
        fun uploadShare(id:Long,userName:String,message:String,address:String,imageOne:String,imageTwo:String,imageThree:String,classification:Int,userImage:String)
