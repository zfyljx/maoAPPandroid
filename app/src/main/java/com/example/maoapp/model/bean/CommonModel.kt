...
data class ShareModelList(val shares:List<ShareModel>){
    data class ShareModel(val id:Long,val userId:Long,val userName:String,val createTime:Date,val message:String,val address:String,val imageOne:String,val imageTwo:String,val imageThree:String)
}
